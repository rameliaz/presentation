...
* Small-to-moderate correlations between atheist identity and science identity (only ![](resources/de.svg){.icon}) with conflict perception. 
* Close to zero correlation between agnostic identity with conflict/compatibility perceptions.
