...
* Barbour [(1966, 1998, 2000, 2002)]{.much-smaller} proposes that people can perceive science (S) and religion (R) as:
  ...
  * Independence: [separate domains]{.mark} or non-overlapping *magisteria* [(Gould, 1999)]{.much-smaller}.
...
* [Assumptions]{.mark}: one cannot fit people neatly into one *taxon* and they are situation-dependent characteristics [(Barbour, 2002)]{.much-smaller}.
* Perceptions of the relationship between S and R is defined as a [mental schema]{.mark} for [processing potentially competing S and R explanations]{.mark}, especially in situations in which both scientific and religious explanations are salient. 
* I will refer to this construct as ['mental models']{.mark} later on. 
...
::: incremental
::: {.smaller}
* [*No* main effect]{.mark} of *n* of explanation (1 vs. 2 vs. 4) and [*no* interaction effect]{.mark} between *n* of explanation and type of explanation (S vs. R).
