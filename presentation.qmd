...
::: {.smaller}
* Barbour introduces a taxonomy, but he cautions [not to use it for categorizing]{.mark} people [(2002)]{.mark}.
...
In addition to qualitative differences, mental models can also imply certain degree of conflict-compatibility, where "conflict" and "consonance" sit in the opposite direction.
...
Convergent validity: compared it with existing scale from Leicht and colleagues which measure same construct with different theoretical reasoning
